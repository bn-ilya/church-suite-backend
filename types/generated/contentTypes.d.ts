...
export interface ApiLiveChatClientLiveChatClient extends Schema.CollectionType {
  ...
  attributes: {
    ...
    live_chat_client_childrens: Attribute.Relation<
      'api::live-chat-client.live-chat-client',
      'oneToMany',
      'api::live-chat-client-children.live-chat-client-children'
    >;
    turnout: Attribute.Integer;
    debt: Attribute.BigInteger & Attribute.DefaultTo<'700'>;
    paid: Attribute.BigInteger & Attribute.DefaultTo<'0'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiLiveChatClientChildrenLiveChatClientChildren
  extends Schema.CollectionType {
  collectionName: 'live_chat_client_childrens';
  info: {
    singularName: 'live-chat-client-children';
    pluralName: 'live-chat-client-childrens';
    displayName: 'Live-chat client childrens';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    name: Attribute.String;
    live_chat_client: Attribute.Relation<
      'api::live-chat-client-children.live-chat-client-children',
      'manyToOne',
      'api::live-chat-client.live-chat-client'
    >;
    turnout: Attribute.Integer & Attribute.DefaultTo<0>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::live-chat-client-children.live-chat-client-children': ApiLiveChatClientChildrenLiveChatClientChildren;
